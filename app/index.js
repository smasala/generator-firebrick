	...
	module.exports = generators.Base.extend( {
	    ...
	    writing: {
	        ...
	        application: function() {
		        var me = this;
		        me.fs.copyTpl( me.templatePath( "app/js/Main.js" ), me.destinationPath( "app/js/Main.js" ), {
	        ...
	        controller: function() {
		        var me = this;
		        me.fs.copyTpl( me.templatePath( "app/js/controller/MainController.js" ), me
		                .destinationPath( "app/js/controller/MainController.js" ), {
			        namespace: me.__vars.ns
		        } );
	        },
	        view: function() {
		        var me = this;
		        me.fs.copy( me.templatePath( "app/js/view/Index.html" ), me.destinationPath( "app/js/view/Index.html" ) );
		        me.fs.copyTpl( me.templatePath( "app/js/view/Index.js" ), me.destinationPath( "app/js/view/Index.js" ), {
			        namespace: me.__vars.ns
		        } );
		        me.fs.copy( me.templatePath( "app/js/view/About.html" ), me.destinationPath( "app/js/view/About.html" ) );
	        }
	    },
